...
namespace CaseApplication.Api.Migrations
{
    ...
    [Migration("20230209074137_InitializeStandartValues")]
    partial class InitializeStandartValues
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CaseApplication.DomainLayer.Entities.PromocodeType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5335710c-a505-4234-b2ee-dc6d91914912"),
                            PromocodeTypeName = "balance"
                        },
                        new
                        {
                            Id = new Guid("6958df03-49a4-4b3d-aad7-ce927c7cd8fa"),
            ...
            modelBuilder.Entity("CaseApplication.DomainLayer.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5d810a50-6b3d-4c3f-bd35-1db9bd709f8e"),
                            RoleName = "user"
                        },
                        new
                        {
                            Id = new Guid("4bd921c4-4241-4584-bdd4-c26afa095168"),
                            RoleName = "admin"
                        });
                });
