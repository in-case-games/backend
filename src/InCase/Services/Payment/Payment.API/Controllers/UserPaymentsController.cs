...
public class UserPaymentsController(IUserPaymentsService paymentsService) : ControllerBase
{
    ...
    [ProducesResponseType(typeof(ApiResult<List<UserPaymentResponse>>), (int)HttpStatusCode.OK)]
    ...
    public async Task<IActionResult> Get(CancellationToken cancellation)
    {
        ...
        return Ok(ApiResult<List<UserPaymentResponse>>.Ok(response));
    }
    ...
    public async Task<IActionResult> GetById(Guid id, CancellationToken cancellation)
    {
        ...
        return Ok(ApiResult<UserPaymentResponse>.Ok(response));
    }
