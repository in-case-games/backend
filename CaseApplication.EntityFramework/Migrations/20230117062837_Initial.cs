        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevenuePrecentage = table.Column<decimal>(type: "DECIMAL(3,5)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LossChance = table.Column<decimal>(type: "DECIMAL(3,5)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2(7)", nullable: true, defaultValue: new DateTime(2023, 1, 17, 9, 28, 37, 90, DateTimeKind.Local).AddTicks(7549))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserBalance = table.Column<decimal>(type: "DECIMAL(3,5)", nullable: false),
                    UserAbleToPay = table.Column<decimal>(type: "DECIMAL(3,5)", nullable: false),
