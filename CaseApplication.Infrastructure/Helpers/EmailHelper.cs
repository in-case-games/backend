...
namespace CaseApplication.Infrastructure.Helpers
{
    ...
    public class EmailHelper
    {
        ...
        public async Task SendSignUpAccountToEmail(EmailPattern emailModel, string uri)
        {
            ...
            string body = CreatePatternBodyV2("Завершение", subTitle: "регистраци", body: patternBody);
        ...
        public async Task SendSignInAccountToEmail(EmailPattern emailModel, string userName)
        {
            ...
            string body = CreatePatternBodyV2("Потдверждение", subTitle: "входа", body: patternBody);
